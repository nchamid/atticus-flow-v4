...
**Inline links** (one or two sources, conversational): wrap the cited phrase in a hyperlink. Use MWS hyperlink style (underlined, navy → blue/teal on hover).
...
- Citations use MWS link styles (CTA for "View sources", hyperlink for inline).
